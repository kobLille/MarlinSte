...
#define MAX_BED_POWER 255// limits duty cycle to bed; 255=full current disco car inutile

 #define  DEFAULT_Kp_bed 530.83
    #define  DEFAULT_Ki_bed 103.84
    #define  DEFAULT_Kd_bed 678.40
